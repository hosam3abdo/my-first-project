...
if($_POST){
    ...
    if($number>100){
     ...
     if($number>150){
       ...
       $tax=$number*$price;
       $theadditional=($tax*.2);
       $total= $tax+$theadditional;
       $reuslt = "your amunt is : $number<br> the price for 1 unit is :$price <br> your tax is : $tax <br> 
       the additional taxs :$theadditional<br> the tota amount: $total  ";
}       
?>
<!doctype html>
<html lang="en">
      ...
      <div class="offset-3 col-6">
        <div class="row">
          <div class="col-12 text-center">
            <h1 class="h1 text-dark"> negatibe or positive </h1>
          </div>
          <div class="col-12">
            <form  method="post">
